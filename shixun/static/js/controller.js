...
function get_left3() {
    $.ajax({
        ...
        type:"post",
        success:function (datas) {
            ec_left3_Option.yAxis[0].data=datas['day']
            ec_left3_Option.series[0].data=datas['dead']
...
function get_right1() {
    $.ajax({
        ...
        success:function (datas) {
            ...
            ec_right1_Option.series[4].data=datas['heal_add']
...
//        success:function (datas) {
//            //ec_right3_Option.xAxis[0].data=datas['day']
//            ec_center_Option.series[0].data=datas['confirm']
//            ec_right3.setOption(ec_right3_Option)
//        },
//        error:function () {
//
